...
minSale = salesArray.min()
maxSale = salesArray.max()
print(minSale, maxSale)
...
array2 = salesArray * 0.02
print()

print("total fees", array2.sum())
...
array3 = salesArray - array2
print(array3)


profitArray = salesArray - array3
print(profitArray)
